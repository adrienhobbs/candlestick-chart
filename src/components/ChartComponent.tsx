      ...
      {lines.map((line) => {
        ...
        return (
          <button
            ...
            className="absolute bg-grey-500/50 hover:bg-red-600 text-white rounded-full w-3 h-3 flex items-center justify-center text-xs font-bold transition-colors z-20"
            style={{
              left: '2px',
              top: `${y - 22}px`,
            }}
